            ...
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                        QuickShow stands out as a comprehensive solution for online movie ticket booking, combining robust features, modern UI, and enterprise-level security for both users and administrators.
                    </p>
